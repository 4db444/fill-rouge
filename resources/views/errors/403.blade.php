...
<head>
    ...
    <title>403 — Access Denied | Splity</title>
...
<body class="font-sans min-h-screen flex flex-col bg-white text-gray-900">
    ...
    <div class="flex-1 flex items-center justify-center px-6 py-8">
        <div class="text-center max-w-md">
            <div class="inline-flex items-center justify-center w-14 h-14 rounded-full bg-gray-100 mb-6">
                <svg class="w-6 h-6 text-gray-500" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0110 0v4"/></svg>
            </div>
            <div class="text-7xl sm:text-8xl font-bold leading-none text-black tracking-tighter mb-2">403</div>
            <div class="w-12 h-0.5 bg-gray-300 mx-auto my-6"></div>
            <h1 class="text-xl font-semibold text-gray-900 mb-3">Access denied</h1>
